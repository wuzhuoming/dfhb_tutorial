...
1. Run the following command 
   ...
   ```bash
   pip install nni && \
   wget https://github.com/vincentcheny/hpo-training/releases/download/dfhb_v1.2/DFHB-1.2-py3-none-any.whl && \
   nnictl package install DFHB-1.2-py3-none-any.whl
   ```

2. if success install, you should see this output  in the command line

   ```bash
   Processing ./DFHB-1.2-py3-none-any.whl
   Installing collected packages: DFHB
   Successfully installed DFHB-1.2
   DFHB installed!
   ```
